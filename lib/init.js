...
const globalRegex = /accessing global/;
let executablePath;
let omitGlobalCheck;
...
export default {
  activate() {
    ...
    this.subscriptions.add(
      atom.config.observe('linter-moonscript.executablePath', (value) => {
        executablePath = value;
      }),
      atom.config.observe('linter-moonscript.omitGlobalCheck', (value) => {
